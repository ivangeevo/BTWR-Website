...
export class EngineBuffMechanic {
  /** Extra wood per Tree Mining while a Saw is powered. */
  sawWood = 1;
  /** Percent shorter Tree Mining hold while a Saw is powered. */
  sawHoldPct = 25;
  ...
  static readonly configFields: MechanicConfigField[] = [
    field("sawWood", "Saw: extra wood", "Extra wood per Tree Mining while powered.", 0, 50, 1),
    field("sawHoldPct", "Saw: faster chop", "Percent shorter Tree Mining hold.", 0, 90, 5, "%"),
