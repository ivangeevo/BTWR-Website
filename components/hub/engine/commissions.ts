...
export const COMMISSION_TEMPLATES: CommissionTemplate[] = [
  ...
  { id: "c-bellows", label: (n) => `Mine ${n} times with the Bellows running`, kind: "counter", counter: "bellowsMines", target: () => 5, rewardSec: 900 },
  ...
  { id: "c-grind", label: (n) => `Turn the crank ${n} times with a Millstone next to it`, kind: "counter", counter: "grinds", target: () => 40, rewardSec: 1200 },
